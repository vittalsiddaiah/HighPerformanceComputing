...
inline auto Label()	{
	std::stringstream lblstr;
	lblstr << "******************************************* HomeWork : 2 *******************************************" << std::endl;
	lblstr << "*                                           Version 0.2                                            *" << std::endl;
	lblstr << "*                              EE 5321 CAE Simulation on HPC Systems                               *" << std::endl;
	lblstr << "*                        Contact: (Vittal) v_s191@txstate.edu  (A04848680)                         *" << std::endl;
	lblstr << "*                                      Texas State University                                      *" << std::endl;
	lblstr << "****************************************************************************************************" << std::endl;
return lblstr.str();
}
/// -----------------------------------------------------------------------
